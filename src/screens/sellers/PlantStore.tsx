...
const staticCarouselData = [
  {
    ...
    price: '$50',
    image:
      'https://hoayeuthuong.com/hinh-hoa-tuoi/cay-de-ban/8204_everyday-with-you.jpg',
    promotion_price: '$45',
  },
  {
    id: 2,
    ...
    price: '$60',
    image:
      'https://bonsaivietnam.com.vn/storage/tung-la-han-cay-canh-18-1659724189677555072607.jpg',
    promotion_price: '$55',
  },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.profileSeller}>
          {user && (
            <>
              <Text style={styles.titleName}>The Owner: {user.name}</Text>
              <View style={styles.logo}>
                <Image source={{uri: user.avatar}} style={styles.logoImage} />
              </View>
            </>
          )}
        </View>
      ...
      <View style={styles.footer}>
        <View style={styles.listActions}>
          <TouchableOpacity style={styles.action} onPress={NavigateOrder}>
...
const styles = StyleSheet.create({
  ...
  titleName: {fontSize: 16, fontWeight: 'bold', color: 'grey'},
  listActions: {
    flexDirection: 'row',
    gap: 20,
    paddingTop: 20,
